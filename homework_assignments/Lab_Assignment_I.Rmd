...
The Center for Bioinformatics also hosts GENAVi via website [junkdnalab.shinyapps.io/GENAVi](https://junkdnalab.shinyapps.io/GENAVi). While not as fast or reliable overall as the standalone version, you can use this in a pinch if you're having difficulty setting up.
...
metadat <- read.csv(
  file = '~/repos/hgg_2020/data/crispri_modelmatrix.csv', 
  header = TRUE,
...
cts <- read.csv(
  '~/repos/hgg_2020/data/combinedfeatcounts.csv', 
  header = TRUE,
  stringsAsFactors = FALSE)
