...
If you haven't done so already, install bioconductor. GENAVi will attempt to install a bunch of dependencies when you first run the app, so pre-install those packages so we can troubleshoot this step seperately. Uncomment any of the following lines you need to run. If you have any difficulty, ask a course instructor for assistance.
